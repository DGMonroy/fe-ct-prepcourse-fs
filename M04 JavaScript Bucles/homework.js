...
function obtenerMayor(x, y) {
   ...
   // Tu código:
   switch (x, y) {case (x>y):return x;
   case (x < y):return y; default:return x}
}
...
function conection(status) {
   ...
   // Tu código:
   switch (status) {case(status=1):return"Online";
...
function saludo(idioma) {
   ...
   // Tu código:
   switch (idioma) {case "aleman":return"Guten Tag!";
...
function colors(color) {
   ...
   // Tu código:
   switch (color){case "blue":`This is ${color}`;
